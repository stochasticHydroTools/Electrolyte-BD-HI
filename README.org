 ...
 *wetHydrodynamicRadius*: The wet hydrodynamic radius, i.e., the radius given to DPStokes.
   ...
   If the wet radius is equal or smaller than the hydrodynamic radius (but positive), full wet is considered and wet radius is overriden to hydrodynamicRadius
